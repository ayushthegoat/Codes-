<h2><a href="https://www.geeksforgeeks.org/problems/nodes-at-even-distance0532/1?page=5&category=Graph&sortBy=submissions">Nodes at even distance</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a connected acyclic graph with n&nbsp;nodes and n-1 edges, count the pair&nbsp;of nodes that are at even distance(number of edges) from each other.</span></p>
