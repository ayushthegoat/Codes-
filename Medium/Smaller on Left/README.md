<h2><a href="https://www.geeksforgeeks.org/problems/smaller-on-left20360700/1?page=5&category=Arrays&difficulty=Medium&sortBy=submissions">Smaller on Left</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr</strong>[ ] of <strong>N</strong> positive integers,&nbsp;the task is to find the greatest element on the left of every element in the array which is strictly smaller than itself, if this element does not exist for an index print "-1".</span></p>
