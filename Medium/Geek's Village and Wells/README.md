<h2><a href="https://www.geeksforgeeks.org/problems/geeks-village-and-wells--170647/1?page=7&category=Matrix,Graph&sortBy=submissions">Geek's Village and Wells</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek's village is represented by a 2-D matrix of characters of size n*m, where</span></p>
