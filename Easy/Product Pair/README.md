<h2><a href="https://www.geeksforgeeks.org/problems/equal-to-product3836/1?page=4&category=Arrays,Strings&difficulty=Easy&sortBy=submissions">Product Pair</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of size <strong>N</strong>&nbsp;of distinct elements and a number <strong>X</strong>, find if there is a pair in arr[] with&nbsp;product equal to <strong>X</strong>.</span></p>
